#!/usr/bin/env python3
"""Daily update merge helper for 2026-08-15.
...
`adjust` is applied on top. Idempotent: an existing 2026-08-15 entry is
...
def merge(slug, payload):
    ...
    refs = payload.get('references') or base['references']
    assert refs, slug
